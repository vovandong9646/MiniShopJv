...
<div class="inner-header">
    <div class="container">
        <div class="pull-left">
            <h6 class="inner-title">${productDetail.getName()}</h6>
        </div>
        <div class="pull-right">
            <div class="beta-breadcrumb font-large">
                <a href="index.html">Home</a> / <span>${productDetail.getTypeProductEntity().getName()}</span> / <span>${productDetail.getName()}</span>
            </div>
        </div>
    ...
    <div id="content">
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <img src="<c:url value='/resources/image/product/${productDetail.getImage()}'/>" alt="">
                    </div>
                    <div class="col-sm-8">
                        <div class="single-item-body">
                            <p class="single-item-title">${productDetail.getName()}</p>
                            <p class="single-item-price">
                                <c:choose>
                                    <c:when test="${productDetail.getPromotionPrice() != 0}">
                                        <span>$ ${productDetail.getPromotionPrice()}</span>
                                    </c:when>
                                    <c:otherwise>
                                        <span>$ ${productDetail.getUnitPrice()}</span>
                                    </c:otherwise>
                                </c:choose>
                            </p>
                        </div>
